...
> 📁 [`projects/snowtooth-ui`](../projects/snowtooth-ui) · API running on port 4000, UI on 5173
...
- Point `main.jsx` at `https://snowtooth.moonhighway.com` instead of localhost — everything should still work. Why is that guaranteed?
